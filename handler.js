...
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𝘼𝙡𝙘𝙖𝘽𝙤𝙩𝙑.24', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
//this.reply(m.chat, `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`, m)
continue //Sin límite
}
if (plugin.level > _user.level) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont9']()} *${plugin.level}* ${lenguajeGB['smsCont10']()} *${_user.level}* ${lenguajeGB['smsCont11']()} *${usedPrefix}nivel*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𝘼𝙡𝙘𝙖𝘽𝙤𝙩𝙑.24', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
...
if (m.money)
m.reply(+m.money + ' 𝘼𝙇𝘾𝘼𝘾𝙊𝙄𝙉𝙎 🐥 𝙐𝙎𝘼𝘿𝙊(𝙎)')  
break
}}} catch (e) {
console.error(e)
} finally {
...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '𝘼𝙡𝙘𝙖𝘽𝙤𝙩𝙑.24 𝗖𝗿𝗲𝗮𝗱𝗼 𝗽𝗼𝗿 @𝗔𝗹𝗰𝗮𝘀𝗵𝗼𝗽.𝗳𝗳') :
...
"thumbnail": apii.data, 
"title": [wm, '𝗔𝗹𝗰𝗮𝗕𝗼𝘁 𝗖𝗿𝗲𝗮𝗱𝗼 𝗽𝗼𝗿 ' + gt + ' 😻', '@𝗔𝗹𝗰𝗮𝘀𝗵𝗼𝗽.𝗳𝗳'].getRandom(),
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, '𝗔𝗹𝗰𝗮𝗕𝗼𝘁 ' + gt + ' 𝗖𝗿𝗲𝗮𝗱𝗼 𝗽𝗼𝗿', '@𝗔𝗹𝗰𝗮𝘀𝗵𝗼𝗽.𝗳𝗳'].getRandom(), thumbnail: gataImg, sourceUrl: accountsgb }}}}, tg)
