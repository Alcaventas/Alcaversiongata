...
this.sendMessage(m.chat, {text: ` 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀 𝗔𝗹𝗰𝗮|𝗥𝗲𝗹𝗼𝗮𝗱`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝗔𝗹𝗰𝗮|𝗥𝗲𝗹𝗼𝗮𝗱⚡ ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
			
m.exp += xp
if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝗔𝗹𝗰𝗮|𝗥𝗲𝗹𝗼𝗮𝗱⚡ ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
...
if (m.money)
m.reply(+m.money + ' ALCACOINS ⚡ 𝙐𝙎𝘼𝘿𝙊(𝙎)')  
break
}}} catch (e) {
console.error(e)
} finally {
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, '😻 Alcabot ' + gt + ' 😻', ''].getRandom(), thumbnail: gataImg, sourceUrl: accountsgb }}}}, tg)
